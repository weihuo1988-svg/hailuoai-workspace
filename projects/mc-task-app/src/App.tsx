 ...
 *
 * 改造说明（Issue #2）：
 *   - 状态来源从 useState(localStorage) 改为 useSync()（SyncProvider 持有）
 *   - SyncProvider 在 src/main.tsx 中包裹整个 App
        ...
        <div style={{ maxWidth: 640, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          {pending && (
            <div style={{
              ...
              <div style={{
                width: 8, height: 8, borderRadius: 0, background: '#FFD700',
          ...
          {syncError && (
            <div style={{
              fontFamily: "'Press Start 2P',monospace", fontSize: 6, color: '#E53935',
            }}>
              同步异常
            </div>
          )}
          <div style={{ display: 'flex', gap: 5, alignItems: 'center' }}>
            {([
              ...
              <div key={idx} style={{
                background: '#1A1A2E', border: '3px solid #3a3a5a',
                borderRadius: 0,
