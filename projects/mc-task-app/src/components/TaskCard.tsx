  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {/* Input: dark bg #0f0f1e, border #3a3a5a, green focus glow */}
        <input
          value={name}
  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Left: MC block icon (48x48, pixelated) */}
        <div style={{
          flexShrink: 0,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            {/* Complete button: MC greenstone style with glow */}
            <button
              onClick={handleClick}
              style={{
                background: 'linear-gradient(180deg,#4CAF50,#2E7D32)',
      ...
      {/* ── Password modal (MC iron door / lever style) ── */}
      {open && (
        <div style={{
